<?php
        ...
        function handleGETRequest() {
            if (connectToDB()) {
                if (array_key_exists('displayArtbyArtist', $_GET)) {
                    handleDisplayArtbyArtistRequest();
                }
        ...
        function handleDisplayArtbyArtistRequest() {
            global $db_conn;
            $res = executePlainSQL("SELECT a3.Title, a.FirstName, a.LastName, a3.Price
                                    FROM Art3 a3, Artist a
